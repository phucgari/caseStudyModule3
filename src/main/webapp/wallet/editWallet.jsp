  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarExample01">
      <ul class="navbar-nav d-flex flex-row">
        ...
        <li class="nav-item me-3 me-lg-0">
          <a class="nav-link" href="https://www.facebook.com/profile.php?id=100013271435313" rel="nofollow" target="_blank">
          ...
          <form class="bg-white  rounded-3 shadow-3-strong p-3" method="post">
            <table style="background: white" cellpadding="3">
              ...
              <tr>
                <th>Name:</th>
                <td>
                  <input type="text" name="name" id="name" value="${requestScope["wallet"].getName()}" size="35"/>*
                </td>
              </tr>
              <tr>
                <th>Balance:</th>
                <td>
                  <input type="text" name="balance" id="balance" value="${requestScope["wallet"].getBalance()}" size="35"/>*
                </td>
              </tr>
              <tr>
                <th></th>
